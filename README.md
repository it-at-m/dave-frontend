...
| DAVe Adapter     | https://github.com/starwit/dave-adapter                    | Connect to data platforms    |
...
Everything one needs to build & run DAVe Frontend can be found [here](/docs/README.md).
