...
export default class GenerateCsvService {
  ...
  private static readonly ENDPOINT: string = "api/dave-backend-service/generate-csv";

  public static generateCsv(zaehlungId: string,
                            options: OptionsDTO): Promise<CsvDTO> {
