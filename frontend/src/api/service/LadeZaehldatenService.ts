...
export default class LadeZaehldatenService {
  ...
  private static readonly ENDPOINT_LADE_ZAEHLDATEN_PROCESSED: string = "api/dave-backend-service/lade-zaehldaten-processed";

  private static readonly ENDPOINT_LADE_BELSTUNGSPLAN: string = "api/dave-backend-service/lade-belastungsplan";

  private static readonly ENDPOINT_LADE_ZEITREIHE: string = "api/dave-backend-service/lade-zeitreihe";

  public static ladeZaehldatenProcessed(zaehlungId: string,
                                        options: OptionsDTO): Promise<LadeProcessedZaehldatenDTO> {
  ...
  public static ladeBelastungsplan(id: string,
                            options: OptionsDTO): Promise<LadeBelastungsplanDTO> {
    return FetchService.postData(
        options,
  ...
  public static ladeZeitreihe(zaehlstelleId: string,
                       zaehlungId: string,
                       options: OptionsDTO): Promise<LadeZaehldatenZeitreiheDTO> {
    return FetchService.postData(
        options,
