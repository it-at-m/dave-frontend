...
const mutations = {
  ...
  setSizeBelastungsplanSvgSchematischeUebersicht(state: any, payload: number) {
    state.sizeBelastungsplanSvgSchematischeUebersicht = payload;
  },
  setMaxSizeBelastungsplanSvgSchematischeUebersicht(state: any, payload: number) {
    state.maxSizeBelastungsplanSvgSchematischeUebersicht = payload;
  },
  setMinSizeBelastungsplanSvgSchematischeUebersicht(state: any, payload: number) {
    state.minSizeBelastungsplanSvgSchematischeUebersicht = payload;
  },
  resetSizeBelastungsplanSvgSchematischeUebersicht(state: any) {
    state.sizeBelastungsplanSvgSchematischeUebersicht = state.minSizeBelastungsplanSvgSchematischeUebersicht;
  },
}
...
const actions = {
  ...
  setSizeBelastungsplanSvgSchematischeUebersicht(context: any, payload: number) {
    context.commit("setSizeBelastungsplanSvgSchematischeUebersicht", payload);
  },
  setMaxSizeBelastungsplanSvgSchematischeUebersicht(context: any, payload: number) {
    context.commit("setMaxSizeBelastungsplanSvgSchematischeUebersicht", payload);
  },
  setMinSizeBelastungsplanSvgSchematischeUebersicht(context: any, payload: number) {
    context.commit("setMinSizeBelastungsplanSvgSchematischeUebersicht", payload);
  },
