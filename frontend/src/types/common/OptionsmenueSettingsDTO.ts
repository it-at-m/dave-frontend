...
export default interface OptionsmenueSettingsDTO {
    ...
    kraftfahrzeugverkehrChoosableIntervals: Array<ZaehldatenIntervall> | undefined;
    ...
    schwerverkehrsanteilProzentChoosableIntervals: Array<ZaehldatenIntervall> | undefined;

    gueterverkehrsanteilProzentChoosableIntervals: Array<ZaehldatenIntervall> | undefined;
