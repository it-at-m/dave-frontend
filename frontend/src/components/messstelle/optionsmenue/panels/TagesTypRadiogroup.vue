  ...
  if (
    ...
    switch (chosenOptionsCopy.value.tagesTyp) {
      case TagesTyp.WERKTAG_DI_MI_DO:
        helpText =
          "Der ausgewählte Zeitraum ist zu kurz. Für die Durchschnittswerteberechnung sind mind. 2 Tage (Di,Mi,Do) und mind. 50% der Tage mit plausiblen Daten nötig.";
        break;
      case TagesTyp.WERKTAG_MO_FR:
        helpText =
          "Der ausgewählte Zeitraum ist zu kurz. Für die Durchschnittswerteberechnung sind mind. 2 Tage (Mo,Di,Mi,Do,Fr) und mind. 50% der Tage mit plausiblen Daten nötig.";
        break;
      case TagesTyp.SAMSTAG:
        helpText =
          "Der ausgewählte Zeitraum ist zu kurz. Für die Durchschnittswerteberechnung sind mind. 2 Tage (Sa) und mind. 50% der Tage mit plausiblen Daten nötig.";
        break;
      case TagesTyp.SONNTAG_FEIERTAG:
        helpText =
          "Der ausgewählte Zeitraum ist zu kurz. Für die Durchschnittswerteberechnung sind mind. 2 Tage (So/Feiertag) und mind. 50% der Tage mit plausiblen Daten nötig.";
        break;
      case TagesTyp.WERKTAG_FERIEN:
        helpText =
          "Der ausgewählte Zeitraum ist zu kurz. Für die Durchschnittswerteberechnung sind mind. 2 Tage (Mo,Di,Mi,Do,Fr Ferien) und mind. 50% der Tage mit plausiblen Daten nötig.";
        break;
      case TagesTyp.MO_SO:
        helpText =
