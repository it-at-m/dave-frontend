...
export default class ZaehldauerIcon extends Vue {
  ...
  get icon() {
    if (!ZaehldauerIcon.zaehldauerIcons().has(this.zaehldauer)) {
      return new IconTooltip("mdi-help-box", "Keine Information zur Zähldauer")
    }
  ...
  static zaehldauerIcons(): Map<string, IconTooltip> {
    return new Map([
      [Zaehldauer.DAUER_2_X_4_STUNDEN, new IconTooltip("$zaehldauer2x4h", "2x4h Zählung")],
      [Zaehldauer.DAUER_24_STUNDEN, new IconTooltip("$zaehldauer24h", "24h Zählung")],
      [Zaehldauer.DAUER_16_STUNDEN, new IconTooltip("$zaehldauer16h", "16h Zählung")],
      [Zaehldauer.DAUER_13_STUNDEN, new IconTooltip("$zaehldauer13h", "13h Zählung")],
