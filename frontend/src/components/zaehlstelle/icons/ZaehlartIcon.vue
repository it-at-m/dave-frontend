...
export default class ZaehlartIcon extends Vue {
  ...
  get icon() {
    if (!ZaehlartIcon.zaehlartIcons().has(this.zaehlart)) {
      return new IconTooltip("mdi-help-box", "Keine Information zur Zählart")
    }
  ...
  static zaehlartIcons(): Map<string, IconTooltip> {
    return new Map([
      ...
      [Zaehlart.H, new IconTooltip("$artH", "Hauptverkehrsrichtung/Oberfläche/Hoch")],
      [Zaehlart.Q, new IconTooltip("$artQ", "Querschnitt")],
      [Zaehlart.QB, new IconTooltip("$artQB", "Bahnschnitt")],
      [Zaehlart.QH, new IconTooltip("$artQH", "Querschnitt/Hauptverkehrsrichtung/Oberfläche/Hoch")],
      ...
      [Zaehlart.QT, new IconTooltip("$artQT", "Querschnitt Tunnel/Unterführung/Tief")],
