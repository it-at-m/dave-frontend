...
export default class BelastungsplanKreisverkehr extends Vue {
    ...
    private fahrzeugkategorieSelected: boolean =
        this.isFahrzeugkategorieSelected;
            ...
            series: [
                {
                    ...
                    data: [
                         ...
                         */
                        {
                            ...
                            label: {
                                ...
                                show: this.visibleNodes[0],
                                position:
                                    this.calculatePositionLabelTriangle(0),
                                rotate: this.visibleNodes[
                        ...
                        },
                        {
                            ...
                            label: {
                                ...
                                show: this.visibleNodes[1],
                                position:
                                    this.calculatePositionLabelTriangle(1),
                                rotate: this.visibleNodes[
                        ...
                        },
                        {
                            ...
                            label: {
                                ...
                                show: this.visibleNodes[2],
                                position:
                                    this.calculatePositionLabelTriangle(2),
                                rotate: this.visibleNodes[
                                    this.previousNodeindex(2)
                                ]
                                    ? this.ROTATE_67_5
                                    : this.ROTATE_45,
                            },
                        },
                        {
                            ...
                            label: {
                                ...
                                show: this.visibleNodes[3],
                                position:
                                    this.calculatePositionLabelTriangle(3),
                                rotate: this.visibleNodes[
                                    this.previousNodeindex(3)
                                ]
                                    ? -this.ROTATE_22_5
                                    : -this.ROTATE_45,
                            },
                        },
                        {
                            ...
                            label: {
                                ...
                                show: this.visibleNodes[4],
                                position:
                                    this.calculatePositionLabelTriangle(4),
                                rotate: this.visibleNodes[
                                    this.previousNodeindex(4)
                                ]
                                    ? this.ROTATE_22_5
                                    : this.ROTATE_0,
                            },
                        },
                        {
                            ...
                            label: {
                                formatter: this.formatLabelTriangle(
                                    5,
                                    this.visibleNodes[this.previousNodeindex(5)]
                                ),
                                show: this.visibleNodes[5],
                                position:
                                    this.calculatePositionLabelTriangle(5),
                                rotate: this.visibleNodes[
                                    this.previousNodeindex(5)
                                ]
                                    ? -this.ROTATE_67_5
                                    : this.ROTATE_90,
                            },
                        },
                        {
                            ...
                            label: {
                                ...
                                show: this.visibleNodes[6],
                                position:
                                    this.calculatePositionLabelTriangle(6),
                                rotate: this.visibleNodes[
                                    this.previousNodeindex(6)
                                ]
                                    ? this.ROTATE_22_5
                                    : this.ROTATE_0,
                            },
                        },
                        {
                            ...
                            label: {
                                formatter: this.formatLabelTriangle(
                                    7,
                                    !this.visibleNodes[
                                        this.previousNodeindex(7)
                                    ]
                                ),
                                show: this.visibleNodes[7],
                                position:
                                    this.calculatePositionLabelTriangle(7),
                                rotate: this.visibleNodes[
                                    this.previousNodeindex(7)
                                ]
                                    ? -this.ROTATE_67_5
                        ...
                        {
                            name: this.START_2S,
                            x: this.calculateXCoord(
                                this.ANGLE_05_PI,
                                this.XCOORD_DEFAULT,
                                this.YCOORD_DEFAULT
                            ),
                            y: this.calculateYCoord(
                                this.ANGLE_05_PI,
                                this.XCOORD_DEFAULT,
                                this.YCOORD_DEFAULT
                            ),
                        },
                        {
                            ...
                            x: this.calculateXCoord(
                                this.ANGLE_05_PI,
                                this.XCOORD_DEFAULT,
                                this.YCOORD_DEFAULT + this.STRAIGHT_DEFAULT
                            ),
                            y: this.calculateYCoord(
                                this.ANGLE_05_PI,
                                this.XCOORD_DEFAULT,
                        ...
                        // Kreis
                        {
                            ...
                            x: this.calculateXCoord(
                                this.ANGLE_0125_PI,
                                this.XCOORD_CIRCLE_DEFAULT,
                                this.YCOORD_CIRCLE_DEFAULT
                            ),
                            y: this.calculateYCoord(
                                this.ANGLE_0125_PI,
                                this.XCOORD_CIRCLE_DEFAULT,
                    ...
                    edges: [
                        // Einfahrend
                        {
                            ...
                            target: this.ENDE_1S,
                            lineStyle: {
                                width: this.calculateLineWidth(
                                    this.getDataToShow()[0][0]
                                ),
                                color: this.COLOR[0],
                            },
                        },
    ...
    get maxNumberOfCarsForWidth() {
        return this.maxNumberOfCars > 0
            ? this.maxNumberOfCars
            : this.calculateMaxNumberOfCars();
    }
    ...
    get isFahrzeugkategorieSelected() {
        return (
            this.selectedOptions.kraftfahrzeugverkehr ||
            this.selectedOptions.schwerverkehr ||
            this.selectedOptions.gueterverkehr ||
            this.selectedOptions.radverkehr ||
            this.selectedOptions.fussverkehr
        );
    }
    ...
    private calculateLineWidthVorbei(node: number): number {
        ...
        while (numberOfCars === 0 && nodeIndex >= 0 && counter < 8) {
            ...
            numberOfCars =
                this.getDataToShow()[nodeIndex][1] +
                this.getDataToShow()[nodeIndex][0];
            counter++;
        }
    ...
    private calculateSymbolSizeForTriangle(nodeIndex: number) {
        if (this.fahrzeugkategorieSelected) {
            ...
            return this.visibleNodes[nodeIndex] &&
                this.getDataToShow()[nodeIndex][2]
                ? this.TRIANGLE_SYMBOL_SIZE
                : 0.001;
        } else {
            return 0;
        }
    ...
    private formatLabelTriangle(node: number, alignLeft: boolean) {
        ...
        if (this.data.value1.filled) {
            ...
            text += this.getTextPartLabelTriangle(
                this.data.value1.sumIn,
                this.previousNodeindex(node),
                this.data.value1.percent
            );
        }
        if (this.data.value2.filled) {
            // Textbausteine mit Daten befüllen
            text += this.getTextPartLabelTriangle(
                this.data.value2.sumIn,
                this.previousNodeindex(node),
                this.data.value2.percent
            );
        }
        if (this.data.value3.filled) {
            // Textbausteine mit Daten befüllen
            text += this.getTextPartLabelTriangle(
                this.data.value3.sumIn,
                this.previousNodeindex(node),
                this.data.value3.percent
            );
        }
    ...
    private getTextPartLabelTriangle(
        data: number[],
        nodeIndex: number,
        percent: boolean
    ): string {
    ...
    private calculateXCoordTriangle(winkel: number) {
        return this.calculateXCoord(
            winkel,
            this.XCOORD_DEFAULT_TRIANGLE,
            this.YCOORD_DEFAULT_TRIANGLE
        );
    }

    private calculateYCoordTriangle(winkel: number) {
        return this.calculateYCoord(
            winkel,
            this.XCOORD_DEFAULT_TRIANGLE,
            this.YCOORD_DEFAULT_TRIANGLE
        );
    ...
    private existsTriangle(nodeIndex: number): boolean {
        return (
            this.calculateSymbolSizeForTriangle(nodeIndex) ===
            this.TRIANGLE_SYMBOL_SIZE
        );
    }
    ...
    private formatLabelNode(node: number) {
        ...
        if (this.data.value1.filled) {
            ...
            let combinedKfz: number = parseFloat(
                this.data.value1.sum[node].toFixed(1)
            );
            dataAvailableRein = dataAvailableRein || kreisReinKfz > 0;
            dataAvailableRaus = dataAvailableRaus || kreisRausKfz > 0;
            lineRein += `${this.padStringAtStart(
                kreisReinKfz.toString(),
                this.MAX_CARS_LENGTH
            )}`;
            lineCombined += `${this.padStringAtStart(
                combinedKfz.toString(),
                this.MAX_CARS_LENGTH
            )}`;
            lineRaus += `${this.padStringAtStart(
        ...
        if (this.data.value2.filled) {
            ...
            let combinedSv: number = parseFloat(
                this.data.value2.sum[node].toFixed(1)
            );
        ...
        if (this.data.value3.filled) {
            ...
            let combinedGv: number = parseFloat(
                this.data.value3.sum[node].toFixed(1)
            );
    ...
    private calculatePositionLabelNode(node: number): Array<number> {
        ...
        switch (node) {
            case 0:
                position = [
                    -31 * this.zoomLvlNodeLabel(0),
                    -55 * this.zoomLvlNodeLabel(0),
                ];
                break;
            case 1:
                position = [
                    75 * this.zoomLvlNodeLabel(1),
                    -30 * this.zoomLvlNodeLabel(1),
                ];
                break;
            case 2:
                position = [
                    -30 * this.zoomLvlNodeLabel(2),
                    365 * this.zoomLvlNodeLabel(2),
                ];
                break;
            case 3:
                position = [
                    -345 * this.zoomLvlNodeLabel(3),
                    -30 * this.zoomLvlNodeLabel(3),
                ];
                break;
            case 4:
                position = [
                    24 * this.zoomLvlNodeLabel(4),
                    -60 * this.zoomLvlNodeLabel(4),
                ];
                break;
            case 5:
                position = [
                    88 * this.zoomLvlNodeLabel(5),
                    28 * this.zoomLvlNodeLabel(5),
                ];
                break;
            case 6:
                position = [
                    -270 * this.zoomLvlNodeLabel(6),
                    232 * this.zoomLvlNodeLabel(6),
                ];
                break;
            case 7:
                position = [
                    -212 * this.zoomLvlNodeLabel(7),
                    -272 * this.zoomLvlNodeLabel(7),
                ];
                break;
        }
        return position;
    ...
    private calculateXCoordNodeLabel(winkel: number) {
        return this.calculateXCoord(
            winkel,
            this.XCOORD_DEFAULT_NODELABEL,
            this.YCOORD_DEFAULT_NODELABEL
        );
    }
