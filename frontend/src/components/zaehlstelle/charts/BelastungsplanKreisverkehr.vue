...
const belastungsplanHeightAndWidth = computed(() => {
  let height = "800px";
  if (display.xl.value || display.lg.value) {
    height = "1000px";
  }
    ...
    series: [
      {
        ...
        data: [
          ...
          {
            name: START_2S,
            x: calculateXCoord(ANGLE_05_PI, XCOORD_DEFAULT, YCOORD_DEFAULT),
            y: calculateYCoord(ANGLE_05_PI, XCOORD_DEFAULT, YCOORD_DEFAULT),
          },
          {
            name: ENDE_2S,
            x: calculateXCoord(
          ...
          {
            name: START_3S,
            x: calculateXCoord(ANGLE_1_PI, XCOORD_DEFAULT, YCOORD_DEFAULT),
            y: calculateYCoord(ANGLE_1_PI, XCOORD_DEFAULT, YCOORD_DEFAULT),
          },
          {
            name: ENDE_3S,
            x: calculateXCoord(
          ...
          {
            name: START_4S,
            x: calculateXCoord(ANGLE_15_PI, XCOORD_DEFAULT, YCOORD_DEFAULT),
            y: calculateYCoord(ANGLE_15_PI, XCOORD_DEFAULT, YCOORD_DEFAULT),
          },
          {
            name: ENDE_4S,
            x: calculateXCoord(
          ...
          {
            name: START_5S,
            x: calculateXCoord(ANGLE_025_PI, XCOORD_DEFAULT, YCOORD_DEFAULT),
            y: calculateYCoord(ANGLE_025_PI, XCOORD_DEFAULT, YCOORD_DEFAULT),
          },
          {
            name: ENDE_5S,
            x: calculateXCoord(
          ...
          {
            name: START_6S,
            x: calculateXCoord(ANGLE_075_PI, XCOORD_DEFAULT, YCOORD_DEFAULT),
            y: calculateYCoord(ANGLE_075_PI, XCOORD_DEFAULT, YCOORD_DEFAULT),
          },
          {
            name: ENDE_6S,
            x: calculateXCoord(
          ...
          {
            name: START_7S,
            x: calculateXCoord(ANGLE_125_PI, XCOORD_DEFAULT, YCOORD_DEFAULT),
            y: calculateYCoord(ANGLE_125_PI, XCOORD_DEFAULT, YCOORD_DEFAULT),
          },
          {
            name: ENDE_7S,
            x: calculateXCoord(
          ...
          {
            name: START_8S,
            x: calculateXCoord(ANGLE_175_PI, XCOORD_DEFAULT, YCOORD_DEFAULT),
            y: calculateYCoord(ANGLE_175_PI, XCOORD_DEFAULT, YCOORD_DEFAULT),
          },
          {
            name: ENDE_8S,
            x: calculateXCoord(
      ...
      case "lg": {
        ...
        switch (nodeIndex) {
          ...
          case 7: // [X,X,X,X]
            ...
            break;
          default:
            zoomlvl = [ZOOM_LVL_LG, ZOOM_LVL_LG, ZOOM_LVL_LG, ZOOM_LVL_LG];
            break;
        }
        break;
      }
...
function formatLabelNode(node: number) {
  ...
  if (props.data.value1.filled) {
    ...
    lineRein += `${padStringAtStart(kreisReinKfz.toString(), MAX_CARS_LENGTH)}`;
    lineCombined += `${padStringAtStart(
      combinedKfz.toString(),
      MAX_CARS_LENGTH
    )}`;
    lineRaus += `${padStringAtStart(kreisRausKfz.toString(), MAX_CARS_LENGTH)}`;
  }
  if (props.data.value2.filled) {
    // Textbausteine mit Daten befüllen
