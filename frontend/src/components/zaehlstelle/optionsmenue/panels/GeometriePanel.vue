  ...
  storeVon(n: number) {
    ...
    if (n === 0) {
      ...
      if (nachK) {
        ...
        console.warn("Für Knotenarm '" + this.nach + "' konnten keine Fahrbeziehungen geladen werden.")
      }
    }
    this.$emit("von", von)
  }
  ...
  storeNach(n: number) {
    ...
    if (n === 0) {
      ...
      if (vonK) {
        ...
        console.warn("Für Knotenarm '" + this.von + "' konnten keine Fahrbeziehungen geladen werden.")
      }
    }
    this.$emit("nach", nach)
  }
