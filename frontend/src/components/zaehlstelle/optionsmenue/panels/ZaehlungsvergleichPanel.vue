 ...
 */
const basisdatum: Ref<string> = computed(() => {
    let result = "";
 ...
 */
const vergleichsdatum: Ref<Array<KeyVal>> = computed(() => {
    return vergleichsdatumDifferenzdarstellung.value;
});

const helpTextDifferenzdatenBelastungsplan: Ref<string> = computed(() => {
...
function update(newOptions: OptionsDTO) {
    ...
    newOptions.differenzdatenDarstellen === null
        ...
        : (differenzdatenDarstellen.value =
