        ...
        >
          ...
          <v-list-item>
            ...
            <v-list-item-subtitle
              >Folgende Informationen werden im PDF Report eingetragen:
              Zählstellen-Nummer, Knoten-/Platzname, Stadtbezirk,
          ...
          <v-list-item>
            ...
            <v-list-item-subtitle
              >Folgende Informationen werden im PDF Report eingetragen:
              Projektname, Zählart, Zähldatum, Zähldauer, Zählsituation und erw.
              Zählsituation, Wetter, Quelle, Zählungskommentar, Knotenarmnummern
              und Straßenamen (1 bis 8), Hinweis auf eine etwaige Sonderzählung
            </v-list-item-subtitle>
          </v-list-item>
          ...
          <v-list-item>
            ...
            <v-list-item-subtitle
              >Folgende Informationen werden im PDF Report eingetragen:
              Uhrzeiten Spitzenstunde (morgens, abends, Tag), Zählblöcke und
              Tageswert (nur wenn 24h Zählung), jeweils mit den jeweiligen
          ...
          <v-list-item>
            ...
            <v-list-item-subtitle
              >Die Legende enthält Kurzbeschreibungen der einzelnen
              Zählattribute, z.B. für den Kraftfahrzeugverkehr, Schwerverkehr
              etc.
            </v-list-item-subtitle>
          </v-list-item>
        </v-list>
