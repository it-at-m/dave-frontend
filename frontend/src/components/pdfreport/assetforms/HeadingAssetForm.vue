  ...
  >
    <v-card>
      <v-card-title class="title grey--text text--lighten-1 grey lighten-2 mb-3">
        <v-icon color="grey lighten-1" class="mr-2">{{ icon }}</v-icon>
            ...
            <v-row>
              <v-col>
                <v-select
                    ...
                    outlined
                    dense
                    v-on:change="setIconAndStyle(asset)"
                ></v-select>
              </v-col>
            </v-row>
          </v-container>
...
export default class HeadingAssetForm extends Vue {
  ...
  icon: string = "mdi-format-header-1"
  style: string = "h1"

  items: string[] = [AssetTypesEnum.HEADING1, AssetTypesEnum.HEADING2, AssetTypesEnum.HEADING3, AssetTypesEnum.HEADING4, AssetTypesEnum.HEADING5]
